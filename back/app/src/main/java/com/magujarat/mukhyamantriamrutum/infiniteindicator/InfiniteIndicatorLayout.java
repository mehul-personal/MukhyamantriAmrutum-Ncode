package com.ncode.mukhyamantriamrutum.infiniteindicator;
...
import com.ncode.mukhyamantriamrutum.R;
import com.ncode.mukhyamantriamrutum.infiniteindicator.indicator.PageIndicator;
import com.ncode.mukhyamantriamrutum.infiniteindicator.indicator.RecyleAdapter;
import com.ncode.mukhyamantriamrutum.infiniteindicator.jakewharton.salvage.RecyclingPagerAdapter;
...
//    private boolean isBorderAnimation = true;
    ...
    public void initFirstPage() {
        if (isInfinite && mRecyleAdapter.getRealCount() > 1) {
            mViewPager.setCurrentItem(mRecyleAdapter.getRealCount() * 50);//50
        } else {
            setInfinite(false);
