...
public class MyAccountActivity extends AppCompatActivity {
    TextView txvFamilyDetailsValue, txvName, txvAddress, txvFemale, txvDOI, txvAvailableBalance, txvCardStatus,txvSchemeTypeValue;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txvSchemeTypeValue=(TextView) findViewById(R.id.txvSchemeTypeValue);
        ...
        btnSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (edtUID.getText().toString().isEmpty()) {
                    Toast.makeText(MyAccountActivity.this, "Please enter URN", Toast.LENGTH_LONG).show();
                } else {
        ...
        getSupportActionBar().setTitle("Get Family Details");
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if (msg.equalsIgnoreCase("success")) {
                                ...
                                txvSchemeTypeValue.setText(dataob.getString("SchemeType"));
                            } else {
