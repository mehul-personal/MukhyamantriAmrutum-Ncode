...
//            paramHealthCampList1,paramHealthCampList2;
    static ArrayList<String> MenuListData,NameList, GRLIST, HOSPITALLIST, ENROLLMENTLIST, HEALTHCAMPLIST, GRLIST1,
...
//            mParam2 = getArguments().getString(ARG_PARAM2);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        wvDateDetail.getSettings().setPluginState(WebSettings.PluginState.ON);
...
//        else
    ...
    public void itemSelection(int position) {
        ...
        if (NameList.get(position).equalsIgnoreCase("GR's")) {
            ...
            if(NameList.get(position).equalsIgnoreCase("1BACK")){
                adapter = new DialogListAdapter(MenuListData);
                lvMenuList.setAdapter(adapter);
                adapter.notifyDataSetChanged();
            }else  if(NameList.get(position).equalsIgnoreCase("1BACK1")){
                adapter = new DialogListAdapter(GRLIST);
                lvMenuList.setAdapter(adapter);
                yearAdd = false;
            }else  if(NameList.get(position).equalsIgnoreCase("1BACK2")){
                adapter = new DialogListAdapter(GRLIST);
                lvMenuList.setAdapter(adapter);
                yearAdd = false;
            }else  if(NameList.get(position).equalsIgnoreCase("2BACK")){
                adapter = new DialogListAdapter(MenuListData);
                lvMenuList.setAdapter(adapter);
                adapter.notifyDataSetChanged();
            }else  if(NameList.get(position).equalsIgnoreCase("2BACK1")){
                adapter = new DialogListAdapter(HOSPITALLIST);
                lvMenuList.setAdapter(adapter);
                yearAdd = false;
            }else  if(NameList.get(position).equalsIgnoreCase("4BACK")){
                adapter = new DialogListAdapter(MenuListData);
                lvMenuList.setAdapter(adapter);
                adapter.notifyDataSetChanged();
            }else  if(NameList.get(position).equalsIgnoreCase("4BACK1")){
                adapter = new DialogListAdapter(HEALTHCAMPLIST);
                lvMenuList.setAdapter(adapter);
                yearAdd = false;
            }else  if(NameList.get(position).equalsIgnoreCase("4BACK2")){
                adapter = new DialogListAdapter(HEALTHCAMPLIST);
                lvMenuList.setAdapter(adapter);
                yearAdd = false;
            }
