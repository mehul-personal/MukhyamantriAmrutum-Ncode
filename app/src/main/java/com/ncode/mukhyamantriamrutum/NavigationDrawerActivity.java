    ...
    public boolean onPrepareOptionsMenu(Menu menu) {
        ...
        search.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                search_list.add("Hospital with details of Arogya Mitra");
        ...
        if (data != null) {
            if (requestCode == 11) {
                if (data.getStringExtra("HEADER").equalsIgnoreCase("Enrollment Kiosk")) {
                    getKisokCenter();
                } else if (data.getStringExtra("HEADER").equalsIgnoreCase("Hospital with details of Arogya Mitra")) {
